...
function createMap(earthquakes, faultlines, timeline) {
  ...
  // Create an overlay object for the overlay layers Earthquakes, Faultlines, Timelines
  ...
  // Create the map, with the streetmap and earthquakes layers - on load display
  ...
  // 2. Pass in the baseMaps and overlayMaps

  // 3. Add the layer control for the map
