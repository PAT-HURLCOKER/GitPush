...
function buildCharts(sample) {
  ...
  d3.json(plotDataset).then(function(plotData){
    ...
    // Initialize a variable for the Bubble Chart, plot the sample data
    ...
    // Initialize a variable for the PIECHART, build a Pie Chart
    ...
    console.log("END ==buildCharts(sample) function");
...
function init() {
  ...
  d3.json("/names").then((sampleNames) => {
    ...
    console.log("End == of of init() function");
