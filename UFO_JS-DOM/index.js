...
function handleSearchButtonClick() {
  ...
  // Set ARRAY filteredUFOs match "date" filter

  filteredUFO = data.filter(function(ufo) {

    var ufoDate = ufo.datetime.toLowerCase();



    // Add the "date" to the filteredUFO, else don't add it to filteredUFO
...
function handleSearchButtonClick1() {
  ...
  // Format the search (trim and lowercase the string text)

  var filterCity = $cityInput.value.trim().toLowerCase();



  // Set ARRAY filteredUFOs match "city" filter
  ...
  filteredUFO = data.filter(function(ufo) {
    ...
    // Add the "city" to the filteredUFO, else don't add it to filteredUFO
...
function handleSearchButtonClick2() {
  ...
  // Set ARRAY filteredUFOs match "state" filter
  ...
  filteredUFO = data.filter(function(ufo) {
    ...
    // Add the "state" to the filteredUFO, else don't add it to filteredUFO
...
function handleSearchButtonClick3() {
  ...
  // Set ARRAY filteredUFOs match "country" filter
  ...
  filteredUFO = data.filter(function(ufo) {
    ...
    // Add the "country" to the filteredUFO, else don't add it to filteredUFO
...
function handleSearchButtonClick4() {
  ...
  // Set ARRAY filteredUFOs match "shape" filter
  ...
  filteredUFO = data.filter(function(ufo) {
    ...
    // Add the "shape" to the filteredUFO, else don't add it to filteredUFO
...
// Render the table on page load to show User 5 records
